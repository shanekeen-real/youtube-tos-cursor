      ...
      {userProfile && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
                ...
                <p className="capitalize text-4xl font-bold text-blue-600 mb-4">{userProfile.subscriptionTier}</p>
                {userProfile.subscriptionTier === 'free' ? (
                    <Button variant="primary" onClick={handleUpgradeClick}>Upgrade to Pro</Button>
                ) : (
                    <p className="text-gray-500">You have unlimited scans.</p>
                )}
            </Card>
            <Card>
                 <h2 className="text-xl font-semibold mb-2">Usage</h2>
                 <p className="text-gray-600">
                    You have used <span className="font-bold text-black">{userProfile.scanCount}</span> of your <span className="font-bold text-black">{userProfile.scanLimit}</span> free scans this month.
                 </p>
